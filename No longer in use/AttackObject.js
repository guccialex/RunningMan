...
class AttackObject extends ObjectOnPlane{
  ...
  constructor(damagetoinflict, timetoprime, timetoexist) {
    ...
    //has a copy of the person who attacked

    //if an entity with an AI was attacked, it needs to know who it was attacked by
    //and attack them and become aggroed to them

    //and do a damage bonus if an entity doesnt see who it was attacked by, sneak bonus
