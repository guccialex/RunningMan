...
class Setting {
  ...
  passinmyguy(myguy) {
    ...
    this.firstplane.passinobject(myguy, this.planestartpos[0], this.planestartpos[1]);
  ...
  updateAI(){
    ...
    //update the AI's sight
    //and update the AI's actions
    //for all the objects on the plane

    //do I update the kingdoms?

    //do I update by plane?
    //do i update by kingdom?
    //will the kingdom have every enemy inside them?

    //how will the kingdoms work
    //hold all the people who are loyal to the main kingdom
    //the kingdom of dwarfs
    //the kingdom of witches
    //the kingdom of all non-descript enemies

    //do enemies change kingdoms?
    //
